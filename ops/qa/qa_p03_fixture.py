...
def main():
    ...
    with schema_context('fhort'):
        ...
        # 06/08 vespre — v. la nota de `qa_p02_fixture.py`: sense model, no s'escriu res (un
        # fixture de 404s damunt d'un de bo deixa tots els fums en vermell sense pista).
