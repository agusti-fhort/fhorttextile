"""Captura les respostes REALS que alimenten la superfície de GRADUACIÓ (P0.5d).
...
SORTIDA = pathlib.Path(__file__).resolve().parent / 'qa_p05d_fixture.json'
MILEY = 1308


def main():
    mid = int(sys.argv[1]) if len(sys.argv) > 1 else 169
    if mid == MILEY:
