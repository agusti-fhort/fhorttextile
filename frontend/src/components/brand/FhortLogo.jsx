// Logotip FHORT (wordmark "Fhort Textile Tech") com a component reutilitzable.
// "Fhort" en gold (var(--gold)) + "Textile Tech" en var(--text-main). Origen: el Logo inline de
// components/layout/Sidebar.jsx, extret aquí perquè el comparteixin la nav i la closca de l'editor.
export default function FhortLogo({ width = 130, style }) {
  return (
    <svg viewBox="0 0 222.7 79.76" xmlns="http://www.w3.org/2000/svg" style={{ width, height: 'auto', display: 'block', ...style }}>
      {/* "Fhort" — gold */}
