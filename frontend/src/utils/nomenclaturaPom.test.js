...
import { nomenclaturaDePom } from './nomenclaturaPom.js'
...
test('sense nom_fitxa ni àlies, el codi CANÒNIC del sector', () => {
  assert.equal(nomenclaturaDePom(bm({ pom_code_global: 'POM-020', codi_client: 'CH' })), 'POM-020')
})
