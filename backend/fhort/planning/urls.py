...
from .views import (company_calendar_view, user_jornada_view, AbsenciaViewSet,
                    ...
                    plan_assign_batch_view, plan_eligible_attendees_view, gantt_view)
...
urlpatterns = [
    ...
    # Sprint M3 — Calendari-Gantt de projecte (barra per model, dies). Gated view_team_tasks.
    path('plan/gantt/', gantt_view, name='plan-gantt'),
    *router.urls,
]
